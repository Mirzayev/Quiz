            ...
            <div className="w-[1440px] h-[720px] bg-[#0D1321] p-[20px] flex justify-around">
                <div className='max-w-[50%] flex flex-col py-[40px]'>
                    ...
                    <div className='flex flex-col gap-[20px]'>  
                        ...
                        <form className='flex flex-col gap-[20px]'>
                            <div className='flex justify-between gap-[15px]'>
                                <div className='flex flex-col w-[50%]'>
                                    <label className='text-white text-[16px] p-[7px] font-bold'>Your first name</label>
                                    <input className='w-full h-[40px] p-[15px] text-[white] rounded-[10px] placeholder:text-[white] bg-[#0D1321] border-[3px] border-[white]' type="email" placeholder='Type your first name'/>
                                </div>

                                <div className='flex flex-col w-[50%]'>
                                    <label className='text-white text-[16px] p-[7px] font-bold'>Your last name</label>
                                    <input className='w-full h-[40px] p-[15px] text-[white] rounded-[10px] placeholder:text-[white] bg-[#0D1321] border-[3px] border-[white]' type="email" placeholder='Type your last name'/>
                                </div>
                            </div>
                            <div className='flex flex-col'>
                                <label className='text-white text-[16px] p-[7px] font-bold'>Your email address</label>
                        ...
                        <div>
                            <button className='bg-[#F5F5F5] text-[#000000] py-[10px] px-[20px] rounded-[10px]'>Sign Un <i class="fa fa-check-circle text-[black]" aria-hidden="true"></i></button>
                        </div>
                    </div>
                </div>
                <div>

...
function Result() {
  ...
  if (loading) {
    return (
      <div className="p-4 ">
        ...
        <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow-md border-spacing-2 border-collapse separate max-h-[450px] overflow-y-auto block">
    ...
    return (
        <div className="flex items-center justify-center mx-auto w-full">
          <div className="p-4">
            <h1 className="text-2xl font-bold mb-4">Quiz Results</h1>
            <table
                className="min-w-full bg-white border border-gray-200 rounded-lg shadow-md border-spacing-2 border-collapse separate max-h-[450px] overflow-y-auto block">
              <thead className="bg-gray-800 text-white">
              <tr>
                <th className="py-3 px-4 text-left">Title</th>
                <th className="py-3 px-4 text-left">Group Name</th>
  ...
  return (
      <div className="py-[50px] px-[40px] border-[1px] border-[#999] rounded-xl shadow-5xl">
        <h1 className="text-2xl font-bold mb-4">Quiz Results</h1>
        <table
            className="min-w-full bg-white border border-gray-200 rounded-lg shadow-md border-spacing-2 border-collapse separate max-h-[450px] overflow-y-auto block">
          <thead className="bg-gray-800 text-white">
